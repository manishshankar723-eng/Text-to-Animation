...
👉 **And read [`RULEBOOK.md`](./RULEBOOK.md) before you change anything.** It is
the short list of every rule this app learned from a live test, ordered by
SCENARIO rather than by date — so the fix that was paid for in August is still
there in October. **Add a row to it when your fix lands.**
